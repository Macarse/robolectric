...
public class RobolectricClassLoader extends javassist.Loader {
    ...
    public Class loadClass(String name) throws ClassNotFoundException {
        boolean shouldComeFromThisClassLoader = !(name.startsWith("org.junit") || name.startsWith("org.hamcrest")  
        		|| name.startsWith("org.specs2") || name.startsWith("scala.") ||
                        name.startsWith("org.apache.http")); //org.specs2 and scala. allows for android projects with mixed scala\java tests to be run with Maven Surefire (see the RoboSpecs project on github)
